...
public class WaBaSchEditAction extends EditAction {
	...
	public void doAction(ActionEvent e) throws Exception {
		if (this.isPowercheck()) {
			...
			PowerCheckUtils.checkHasPermission(new IBill[] { bill }, this.getBillType(), PowerActionEnum.EDIT.getActioncode(), this.getBillCodeName());
		}
		super.doAction(e);
	}
