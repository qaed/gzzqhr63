...
public class NotifyTodoSendContext  implements java.io.Serializable {
    ...
    private java.lang.String extendContent;
    ...
    public NotifyTodoSendContext(
           ...
           java.lang.String extendContent,
     ...
     */
    public java.lang.String getExtendContent() {
        return extendContent;
    }
     ...
     * @param extendContent
     */
    public void setExtendContent(java.lang.String extendContent) {
        this.extendContent = extendContent;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservice.notify.sys.kmss.landray.com/", "notifyTodoSendContext"));
	...
	public String toString() {
		return "NotifyTodoSendContext [appName=" + appName + ", createTime="
				+ createTime + ", docCreator=" + docCreator
				+ ", extendContent=" + extendContent + ", key=" + key
				+ ", level=" + level + ", link=" + link + ", modelId="
				+ modelId + ", modelName=" + modelName + ", others=" + others
				+ ", param1=" + param1 + ", param2=" + param2 + ", subject="
				+ subject + ", targets=" + targets + ", type=" + type + "]";
	}
